class SalesController < ApplicationController
  ...
  def create
  	...
  	exento_iva = (params[:sale][:exento_iva] == '1')
  	...
  	if sale.save
  		redirect_to sales_done_path, notice: "El registro fue creado con exito"
  	else
  		redirect_to root_path, notice: "No se a registrado con exito" 
  	end
